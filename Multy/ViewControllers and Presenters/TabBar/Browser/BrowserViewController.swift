...
class BrowserViewController: UIViewController {
    ...
    lazy var config: WKWebViewConfiguration = {
        //TODO
        let config = WKWebViewConfiguration.make(for: "0x7c1f8268206c8466e9e8bdeb6e1fa418760ff9f0",
    ...
    init(
        ...
        NSLayoutConstraint.activate([
            webView.topAnchor.constraint(equalTo: browserView.layoutGuide.topAnchor),// topLayoutGuide.bottomAnchor),
            webView.leadingAnchor.constraint(equalTo: browserView.leadingAnchor),
            webView.trailingAnchor.constraint(equalTo: browserView.trailingAnchor),
            webView.bottomAnchor.constraint(equalTo: browserView.bottomAnchor),// bottomLayoutGuide.topAnchor),
            
            progressView.topAnchor.constraint(equalTo: browserView.layoutGuide.topAnchor),
